...
class TransfersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transfer" do
    assert_difference('Transfer.count') do
      post transfers_url, params: { transfer: { amount: @transfer.amount, currency: @transfer.currency } }
    end
  ...
  test "should update transfer" do
    patch transfer_url(@transfer), params: { transfer: { amount: @transfer.amount, currency: @transfer.currency } }
